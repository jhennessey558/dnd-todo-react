    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            <input
                ...
                type="text"
                value={task.name}
                className="border-2 border-slate-400 bg-slate-100 rounded-md mr-1 h-6 w-64 px-1"
            />
            <button className="bg-indigo-500 rounded-md px-20 h-6 text-white">Create</button>
        </form>
    )
};